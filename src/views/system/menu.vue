<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="权限标识" min-width="100px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.code }}</span>
        </template>
      </el-table-column>

      <el-table-column label="创建日期" min-width="150px" align="center">
        <template slot-scope="scope">
    ...
    <el-dialog :close-on-click-modal="false" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible"
      ...
      <!--
            ...
            >
              ...
              <div v-if="type==='目录'">
                ...
                <el-form-item label="菜单可见：" prop="enabled">
      &lt;!&ndash;            <el-switch
                    v-model="temp.hidden"
                    active-color="#13ce66"
                ...
                <el-form-item label="是否始终显示根路由：" prop="enabled">
                  <el-switch
      ...
      <el-form ref="menuForm" :inline="true" :model="temp" :rules="rules" size="small" label-width="80px">
        ...
        <!--        <el-form-item v-show="temp.type !== '2'" label="菜单图标">
                  <el-popover
                ...
                <el-form-item v-show="temp.type !== '2'" label="外链菜单">
                  <el-radio-group v-model="temp.iframe" size="mini">
                    <el-radio-button label="true">是</el-radio-button>
                    <el-radio-button label="false">否</el-radio-button>
                  </el-radio-group>
                </el-form-item>
                <el-form-item v-show="temp.type === '1'" label="菜单缓存">
                  <el-radio-group v-model="temp.cache" size="mini">
                    <el-radio-button label="true">是</el-radio-button>
                    <el-radio-button label="false">否</el-radio-button>
                  </el-radio-group>
                </el-form-item>-->
        <el-form-item v-show="temp.type !== '2'" label="菜单可见">
          <el-radio-group v-model="temp.hidden" size="mini">
            <el-radio-button label="false">是</el-radio-button>
            <el-radio-button label="true">否</el-radio-button>
          </el-radio-group>
        </el-form-item>
        <div v-show="temp.type === '2'" style="width: 178px;"/>
        <el-form-item v-show="temp.type !== '2'" label="菜单标题" prop="name">
          <el-input v-model="temp.name" style="width: 178px" placeholder="菜单标题"/>
        </el-form-item>
        <el-form-item v-show="temp.type === '2'" label="按钮名称">
          <el-input v-model="temp.name" placeholder="按钮名称" style="width: 178px;"/>
        </el-form-item>
        <el-form-item label="权限标识">
          <!--          <el-input :disabled="temp.iframe === 'true'" v-model="temp.code" placeholder="权限标识" style="width: 178px;"/>-->
          <el-input v-model="temp.code" placeholder="权限标识" style="width: 178px;"/>
        </el-form-item>
        <!--        <el-form-item v-if="temp.type !== '2'" label="路由地址" prop="path">
                  <el-input v-model="temp.path" placeholder="路由地址" style="width: 178px;"/>
                </el-form-item>-->
        <!--        <el-form-item label="菜单排序">
                  <el-input-number v-model.number="temp.sort" :min="0" :max="999" controls-position="right" style="width: 178px;"/>
                </el-form-item>-->
        <!--        <el-form-item v-show="temp.iframe === 'false' && temp.type === '1'" label="组件名称">
                  <el-input v-model="temp.componentName" style="width: 178px;" placeholder="匹配组件内Name字段"/>
                </el-form-item>
                <el-form-item v-show="temp.iframe === 'false' && temp.type === '1'" label="组件路径">
